...
namespace student_management.Controllers
{
    public class RegistationController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,firstname,lastname,nic,course_id,batch_id")] registation registation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,firstname,lastname,nic,course_id,batch_id")] registation registation)
        {
            if (ModelState.IsValid)
            {
